...
def main():
    ...
    best_dict, best_cats = calculate_metric(ref_m2, hyp_m2, args)
    # Print results
...
def calculate_metric(ref_m2, hyp_m2, args):
    # Open hypothesis and reference m2 files and split into chunks
    if args.start is not None and args.end is not None:
        ref_m2 = ref_m2[args.start:args.end]
        hyp_m2 = hyp_m2[args.start:args.end]
